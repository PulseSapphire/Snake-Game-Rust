...
pub trait IterableBoard<'a, P: Position, I: BoardIterator<'a, P>>: IntoIterator<Item = (P, &'a BoardTile), IntoIter = I> {}
pub trait IterableBoardMut<'a, P: Position, I: BoardIteratorMut<'a, P>>: IntoIterator<Item = (P, &'a mut BoardTile), IntoIter = I> {}